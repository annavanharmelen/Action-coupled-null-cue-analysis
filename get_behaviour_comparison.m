...
errorbar([1:3], mean(con_dt_effect), std(con_dt_effect) ./ sqrt(size(pp2do,2)), 'LineWidth', 1.5);
xticks([1,2,3]);
...
errorbar([1:3], mean(con_er_effect), std(con_er_effect) ./ sqrt(size(pp2do,2)), 'LineWidth', 1.5);
xticks([1,2,3]);
xticklabels({"Study 1", "Study 2", "Study 3"});
...
subplot(2,2,3)
scatter([ones(25,1), ones(25,1)*2, ones(25,1)*3], con_dt_effect);
xlimit([0 4])
xticks([1,2,3]);
xticklabels({"Study 1", "Study 2", "Study 3"});

subplot(2,2,4)
scatter([ones(25,1), ones(25,1)*2, ones(25,1)*3], con_er_effect);
xlimit([0 4])
xticks([1,2,3]);
xticklabels({"Study 1", "Study 2", "Study 3"});
...
subplot(1,2,2)
scatter(con_er_effect, squeeze(avg_saccade_effect(1,:,:)));
xlabel('congruency effect of ERROR');
ylabel('congruency effect of SACCADE BIAS');
...
subplot(1,2,1)
hold on
scatter(con_dt_effect(:,1), squeeze(avg_saccade_effect(1,:,1))');
...
legend({"Study 1", "Study 2 + 3"});

subplot(1,2,2)
hold on
scatter(con_er_effect(:,1), squeeze(avg_saccade_effect(1,:,1))');
...
tL = subplot(2,3,1);
hold on 
b = bar(mean(squeeze(congruency_dt(1,:,1:2))), 'FaceColor', 'flat', 'LineStyle', 'none', 'BarWidth', bar_width);
b.CData(1,:) = get_colour("blue", "");
b.CData(2,:) = get_colour("red", "");
errorbar([1], mean(squeeze(congruency_dt(1,:,1))), std(squeeze(congruency_dt(1,:,1))) ./ sqrt(size(pp2do, 2)), 'LineStyle', 'none', 'LineWidth', 1.5, 'Color', get_colour("blue", "dark"))
errorbar([2], mean(squeeze(congruency_dt(1,:,2))), std(squeeze(congruency_dt(1,:,2))) ./ sqrt(size(pp2do, 2)), 'LineStyle', 'none', 'LineWidth', 1.5, 'Color', get_colour("red", "dark"))
xticks([1,2]);
...
% add individuals
plot([1:2], squeeze(congruency_dt(1,:,1:2)), 'Color', [0, 0, 0, 0.25], 'LineWidth', 0.75);
...
tR = subplot(2,3,3);
hold on
b = bar([mean(con_dt_effect(:,1)), mean(con_dt_effect(:,2:3), "all")], 'FaceColor', 'flat', 'LineStyle', 'none', 'BarWidth', bar_width);
b.CData(1,:) = get_colour("pink", "");
b.CData(2,:) = [0.5, 0.5, 0.5];
errorbar([1], mean(con_dt_effect(:,1)), std(con_dt_effect(:,1)) ./ sqrt(size(pp2do,2)), 'LineWidth', 1.5, 'Color', get_colour("pink", "dark"));
...
bL = subplot(2,3,4);
hold on 
b = bar(mean(squeeze(congruency_er(1,:,1:2))), 'FaceColor', 'flat', 'LineStyle', 'none', 'BarWidth', bar_width);
b.CData(1,:) = get_colour("blue", "");
b.CData(2,:) = get_colour("red", "");
errorbar([1], mean(squeeze(congruency_er(1,:,1))), std(squeeze(congruency_er(1,:,1))) ./ sqrt(size(pp2do, 2)), 'LineStyle', 'none', 'LineWidth', 1.5, 'Color', get_colour("blue", "dark"))
errorbar([2], mean(squeeze(congruency_er(1,:,2))), std(squeeze(congruency_er(1,:,2))) ./ sqrt(size(pp2do, 2)), 'LineStyle', 'none', 'LineWidth', 1.5, 'Color', get_colour("red", "dark"))
xticks([1,2]);
xticklabels(congruency_labels(1:2));
xlim(xlimit);
ylim(er_ylim);
...
% add individuals
plot([1:2], squeeze(congruency_er(1,:,1:2)), 'Color', [0, 0, 0, 0.25], 'LineWidth', 0.75);
...
bR = subplot(2,3,6);
hold on
b = bar([mean(con_er_effect(:,1)), mean(con_er_effect(:,2:3), "all")], 'FaceColor', 'flat', 'LineStyle', 'none', 'BarWidth', bar_width);
b.CData(1,:) = get_colour("pink", "");
b.CData(2,:) = [0.5, 0.5, 0.5];
errorbar([1], mean(con_er_effect(:,1)), std(con_er_effect(:,1)) ./ sqrt(size(pp2do,2)), 'LineWidth', 1.5, 'Color', get_colour("pink", "dark"));
